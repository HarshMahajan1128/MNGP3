...
function keyPressed() {
  // console.log('keyPressed')
   if(keyCode === 72 && w1Count < 10) /* h */ {
    ...
    weapon2 = new Weapon(tank.body.position.x, tank.body.position.y)
    ...
    weapon3 = new Weapon(tank.body.position.x, tank.body.position.y)
    ...
    weapon4 = new Weapon(tank.body.position.x, tank.body.position.y)
    ...
    weapon5 = new Weapon(tank.body.position.x, tank.body.position.y)
    ...
    weapon6 = new Weapon(tank.body.position.x, tank.body.position.y)
    ...
    weapon7 = new Weapon(tank.body.position.x, tank.body.position.y)
  ...
  if(keyCode === 65 && w11Count < 10) /* a */ {
    ...
    weapon12 = new Weapon(enemy.body.position.x, enemy.body.position.y, w11img);
    ...
    weapon13 = new Weapon(enemy.body.position.x, enemy.body.position.y, w11img);
    ...
    weapon14 = new Weapon(enemy.body.position.x, enemy.body.position.y, w11img);
    ...
    weapon15 = new Weapon(enemy.body.position.x, enemy.body.position.y, w11img);
    ...
    weapon16 = new Weapon(enemy.body.position.x, enemy.body.position.y, w11img);
    ...
    weapon17 = new Weapon(enemy.body.position.x, enemy.body.position.y, w11img);
